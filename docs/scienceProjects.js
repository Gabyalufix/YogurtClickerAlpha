...
STATICVAR_HOLDER.LEVELLED_SCIENCE_POWERMOD = 3.179 // Math.sqrt(11);
STATICVAR_HOLDER.LEVELLED_SCIENCE_BASE = 7.2e22 / 2;
...
Object.keys(STATICVAR_HOLDER.SCIENCE.TECHTREE).forEach(function(pid,index){
    ...
    Object.keys(STATICVAR_HOLDER.SCIENCE.TECHTREE).forEach(function(cpid,index){
        ...
        STATICVAR_HOLDER.SCIENCE.TECHTREE[cpid].IDX = index
