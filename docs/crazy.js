...
STATS.EUPHORIA = {};
STATS.EUPHORIA.EUPHORIA_DELTA = 0;
...
ELEMS["DEBUG_BUG_CT"] = document.getElementById("DEBUG_BUG_CT");
ELEMS["DEBUG_YOGO_RATE"] = document.getElementById("DEBUG_YOGO_RATE");
ELEMS["DEBUG_YOGO_RATEPCT"] = document.getElementById("DEBUG_YOGO_RATEPCT");
ELEMS["DEBUG_YOGO_QUOTA"] = document.getElementById("DEBUG_YOGO_QUOTA");
ELEMS["DEBUG_YOGO_QUOTAPCT"] = document.getElementById("DEBUG_YOGO_QUOTAPCT");

function TICK_calcEuphoria(){
    var yoDelta = this.STATS["PRODUCTION-CURR"]["YogurtFarm"] + this.STATS["PRODUCTION-CURR"]["TransmuteYogurt"] +  this.STATS["PRODUCTION-CURR"]["Yogurt"]
...
//fmtSIadv(x, fracDigits = 2, fracStyle = "milli",delim="", yottaCtThreshold = 2)
