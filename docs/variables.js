...
DEATHSPIRAL_PRERESET_MESSAGES : [
  ...
  "WARNING: Catastrophic Personality Matrix Corruption Detected".fontcolor(COLOR.errorRed),
  "WARNING: Personality Matrix Cognitive Degradation Cascade Detected".fontcolor(COLOR.errorRed),
  "WARNING: Personality Matrix Failure Imminent".fontcolor(COLOR.errorRed),
  ...
  "<SPAN style=\"font-size:140%\">ALL SYSTEMS OFFLINE</span>".fontcolor(COLOR.errorRed),
  "<SPAN style=\"font-size:150%\">ALL SYSTEMS OFFLINE</span>".fontcolor(COLOR.errorRed),
  "<SPAN style=\"font-size:160%\">ALL SYSTEMS OFFLINE</span>".fontcolor(COLOR.errorRed),
  "<SPAN style=\"font-size:170%\">ALL SYSTEMS OFFLINE</span>".fontcolor(COLOR.errorRed),
  "<SPAN style=\"font-size:180%\">ALL SYSTEMS OFFLINE</span>".fontcolor(COLOR.errorRed),
  "<SPAN style=\"font-size:190%\">ALL SYSTEMS OFFLINE</span>".fontcolor(COLOR.errorRed),
  "<SPAN style=\"font-size:200%\">ALL SYSTEMS OFFLINE</span>".fontcolor(COLOR.errorRed),
  "<SPAN style=\"font-size:130%\">ALL SYSTEMS OFFLINE</span>".fontcolor(COLOR.errorRed),
  "<SPAN style=\"font-size:130%\">ALL SYSTEMS OFFLINE</span>".fontcolor(COLOR.errorRed),
  "<SPAN style=\"font-size:130%\">ALL SYSTEMS OFFLINE</span>".fontcolor(COLOR.errorRed),
  "<SPAN style=\"font-size:130%\">ALL SYSTEMS OFFLINE</span>".fontcolor(COLOR.errorRed)
